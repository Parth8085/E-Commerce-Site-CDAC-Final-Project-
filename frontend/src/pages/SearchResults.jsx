...
const SearchResults = () => {
    ...
    useEffect(() => {
        const fetchSearchResults = async () => {
            setLoading(true);
            try {
                const response = await api.get(`/product?search=${encodeURIComponent(searchQuery)}`);
    ...
    if (loading) return <div style={{ textAlign: 'center', marginTop: '2rem' }}>Searching for "{searchQuery}"...</div>;
        ...
        <div className="animate-fade-in">
            ...
            {products.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '4rem', color: 'var(--text-light)' }}>
                    ...
                    <p>Try searching with different keywords like brand names (Apple, Samsung), categories (Mobiles, Laptops), or product types.</p>
